...
type Estate struct {
	...
	Point       interface{} `db:"point" json:"_"`
...
func searchEstateNazotte(c echo.Context) error {
	...
	estates := []Estate{}
	query := fmt.Sprintf(`SELECT * FROM estate WHERE ST_Contains(ST_PolygonFromText(%s), point) LIMIT 51`, coordinates.coordinatesToText())
